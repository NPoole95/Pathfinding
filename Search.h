...
public:
	...
	virtual bool FindPath(TerrainMap& terrain, unique_ptr<SNode> start, unique_ptr<SNode> goal, NodeList& path, int mapYSize, int mapXSize, I3DEngine* myEngine, vector<vector<IModel*>> myMapDisplay) = 0;
